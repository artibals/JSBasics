...
var mikeTeamAverage = (120 + 94 + 123) / 3;
var maryTeamAverage = (117 + 94 + 123) / 3;
...
if (johnTeamAverage > mikeTeamAverage && johnTeamAverage > maryTeamAverage) {
    console.log('John\'s team wins with average score ' + johnTeamAverage);
} else if (mikeTeamAverage > johnTeamAverage && mikeTeamAverage > maryTeamAverage) {
    console.log('Mike\'s team wins with average score ' + mikeTeamAverage);
} else if (maryTeamAverage > johnTeamAverage && maryTeamAverage > mikeTeamAverage) {
    console.log('Marie\'s team wins with average score ' + maryTeamAverage);
} else {
